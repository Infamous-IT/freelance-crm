...
export class CreateOrderDto {
    ...
    @ApiProperty({
        example: 'Реалізація функціоналу відображення замовлень для авторизованого користувача.',
    ...
    @ApiProperty({
        ...
        description: 'Унікальний ідентифікатор користувача, хто виконує замовлення (UUID)',
    })
    @IsString()
    @IsNotEmpty()
    userId: string;
    ...
    @ApiProperty({
        example: 'a3bb189e-8bf9-3888-9912-ace4e6543002',
        description: 'Унікальний ідентифікатор замовника, хто дав замовлення (UUID)',
    })
    @IsOptional()
    customerId?: string;
}
